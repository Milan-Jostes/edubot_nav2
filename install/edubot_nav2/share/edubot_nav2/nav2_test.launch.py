...
def generate_launch_description():
    ...
    #Custom Directory to edit files
    cur_dir = os.path.join(os.getcwd(),'src','edubot_nav2')
    maps_dir = os.path.join(cur_dir,'maps')
    world_dir = os.path.join(cur_dir,'world')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(maps_dir,'test.yaml'),
    )
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(cur_dir, 'params', 'nav2_params.yaml'),
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(cur_dir, 'description', 'gz_waffle.sdf.xacro'),
        description='Full path to robot sdf file to spawn the robot in gazebo',
    )

    urdf = os.path.join(cur_dir, 'description', 'turtlebot3_waffle.urdf')
